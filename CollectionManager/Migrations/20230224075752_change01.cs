        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ithems_Collections_CollectionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IthemId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comments_Ithems_IthemId",
                        column: x => x.IthemId,
                        principalTable: "Ithems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IthemsId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    TagsId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_IthemTag", x => new { x.IthemsId, x.TagsId });
                    table.ForeignKey(
                        name: "FK_IthemTag_Ithems_IthemsId",
                        column: x => x.IthemsId,
                        principalTable: "Ithems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_IthemTag_Tags_TagsId",
                        column: x => x.TagsId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Likes", x => new { x.IthemId, x.UserId });
                    table.ForeignKey(
                        name: "FK_Likes_Ithems_IthemId",
                        column: x => x.IthemId,
                        principalTable: "Ithems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_IthemId",
                table: "Comments",
                column: "IthemId");

            migrationBuilder.CreateIndex(
                name: "IX_Ithems_CollectionId",
                table: "Ithems",
                column: "CollectionId");

            migrationBuilder.CreateIndex(
                name: "IX_IthemTag_TagsId",
                table: "IthemTag",
                column: "TagsId");
        }
